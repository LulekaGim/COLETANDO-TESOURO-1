var path,boy,cash,diamonds,jwellery,sword,boydead,gameOver;
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg,boydeadImg,gameOverImg;
...
function preload(){
  ...
  boydeadImg =loadImage("dead man-02 (1).png");
...
boydead = createSprite(200,500,1,1);
boydead.scale=0.1; 
